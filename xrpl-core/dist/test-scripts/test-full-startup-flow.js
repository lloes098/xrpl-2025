...
async function testFullStartupFlow() {
    ...
    try {
        ...
        const projectResponse = await axios_1.default.post('http://localhost:3001/api/projects', startupProjectData);
        if (projectResponse.status === 201) {
            ...
            try {
                const milestoneResponse = await axios_1.default.post(`http://localhost:3001/api/projects/${projectId}/milestones/${projectResponse.data.milestones[0].id}/achieve`, {
...
//# sourceMappingURL=test-full-startup-flow.js.map